...
// Validate ../../src/app/api/generate-download-token/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/generate-download-token">> = Specific
  const handler = {} as typeof import("../../src/app/api/generate-download-token/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
